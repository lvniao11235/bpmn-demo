 ...
 *
 * ```
 * var TestHelper = module.exports = require('@/components/bpmn/bpmn-js/test/helper').default;
 *
 * var fs = require('fs');
 *
 * // insert diagram.css
...
var Modeler = require('@/components/bpmn/bpmn-js/lib/Modeler').default,
    Viewer = require('@/components/bpmn/bpmn-js/lib/Viewer').default;
