...
```javascript
var BpmnJS = require('@/components/bpmn/bpmn-js/lib/Modeler'),
    propertiesPanelModule = require('@/components/bpmn/bpmn-js-properties-panel'),
    propertiesProviderModule = require('@/components/bpmn/bpmn-js-properties-panel/lib/provider/bpmn');
...
var BpmnJS = require('@/components/bpmn/bpmn-js/lib/Modeler'),
    ...
    propertiesProviderModule = require('@/components/bpmn/bpmn-js-properties-panel/lib/provider/camunda');
