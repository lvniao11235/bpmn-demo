...
var is = require('@/components/bpmn/bpmn-js/lib/util/ModelUtil').is,
    isAny = require('@/components/bpmn/bpmn-js/lib/features/modeling/util/ModelingUtil').isAny,
...
module.exports = function(group, element, bpmnFactory, translate) {
    ...
    group.entries.push({
        ...
        set: function(element, values, containerElement) {
            ...
            var update = conditionalEventDefinition ? { condition: conditionOrConditionExpression } : { conditionExpression: conditionOrConditionExpression };
