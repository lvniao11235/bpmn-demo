...
module.exports = function(element, bpmnFactory, options, translate) {
    ...
    entries.push(entryFactory.textField(translate, {
        ...
        validate: function(element, values, node) {
            ...
            return (
                ...
                getCallActivityBindingValue(element) === 'version' && (!version ? { callableVersion: translate('Must provide a value') } : {})
            );
        },
    ...
    entries.push(entryFactory.textField(translate, {
        ...
        validate: function(element, values, node) {
            ...
            return (
                isSupportedCallableType(type) &&
                getCallActivityBindingValue(element) === 'versionTag' && (!versionTag ? { versionTag: translate('Must provide a value') } : {})
            );
        },
    ...
    entries.push(entryFactory.textField(translate, {
        ...
        validate: function(element, values, node) {
            var delegateVariableMapping = values.delegateVariableMapping;
            return (
                getCallableType(element) === 'bpmn' && (!delegateVariableMapping ? { delegateVariableMapping: translate('Must provide a value') } : {})
            );
        },
